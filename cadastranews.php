...
<div id="formnews">
  <fieldset>
    <legend>Cadastrar nova Newsletter</legend>
    <table width="100%" border="0">
    <form action="processa_cadastranews.php" method="post" enctype="multipart/form-data" name="cadastrarnews" id="cadastrarnews">
      <tr>
      ...
      <tr>
        ...
        <td><textarea name="texto" id="texto" cols="50" rows="8"></textarea></td>
      </tr>
      <tr>
