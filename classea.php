...
//-->
    ...
    <div id="main">
      <div id="content_left">
        <h3>CLASSE A – CONSULTORIA, ASSESSORIA E EVENTOS.<img src="images/photo_classe-a.jpg" width="250" height="180" class="pic_left" /></h3>
        <p>Iniciamos nossos trabalhos em 2004 com o propósito de apoiar os profissionais   da área de Recursos Humanos de órgãos públicos e privados.</p>
        <p>Desde então, trabalhamos com foco no capital humano das organizações visando   à eficácia das pessoas, eficiência dos processos, efetividade dos resultados e   economicidade das organizações.</p>
        <p>Apoiamos as organizações de forma a otimizar tempo, capital e processos, por   meio de serviços especializados e de qualidade. </p>
<p>Com vários clientes de grande porte,   tivemos a oportunidade de adquirir parcerias preciosas, que fazem a diferença.   Para isso, A Equipe Classe A é formada por profissionais e instrutores especializados de formação superior,   pós-graduados e com vasta experiência operacional e gerencial.</p>
      </div>
